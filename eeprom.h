...
********************************************************************************/
static inline int eeprom_write_byte(const uint16_t address, 
                                    const uint8_t data)
{
...
********************************************************************************/
static inline uint8_t eeprom_read_byte(const uint16_t address)
{
...
*                    - data       : Datan som ska skrivas.
********************************************************************************/
static inline int eeprom_write_word(const uint16_t address_low, 
                                    const uint16_t data)
{
...
*                                  ska läsas av.
********************************************************************************/
static inline uint16_t eeprom_read_word(const uint16_t address_low)
{
   if (address_low > EEPROM_ADDRESS_MAX - 1) return 0;
   return eeprom_read_byte(address_low) | (eeprom_read_byte(address_low + 1) << 8);
}
